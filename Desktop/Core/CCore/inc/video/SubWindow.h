...
class WindowList : public NoCopyBase<SubWindowHost,UserInput>
 {
  ...
  public:
   ...
   void react(UserAction action,FuncArgType<UserAction> auto func);

   bool react_Keyboard(UserAction action);

   void react_Keyboard(UserAction action,FuncArgType<UserAction> auto func);

   bool react_Mouse(UserAction action);

   void react_Mouse(UserAction action,FuncArgType<UserAction> auto func);

   bool react_Move(Point point,MouseKey mkey);

   void react_Move(Point point,MouseKey mkey,FuncArgType<UserAction> auto func);

   void react_Leave(FuncArgType<UserAction> auto func);
...
void WindowList::react_Keyboard(UserAction action,FuncArgType<UserAction> auto func)
 {
  if( !react_Keyboard(action) ) func(action);
 }

void WindowList::react_Mouse(UserAction action,FuncArgType<UserAction> auto func)
 {
  if( !react_Mouse(action) ) func(action);
 }

void WindowList::react_Move(Point point,MouseKey mkey,FuncArgType<UserAction> auto func)
 {
  if( !react_Move(point,mkey) ) UserInputFunc(func).put_Move(point,mkey);
 }

void WindowList::react_Leave(FuncArgType<UserAction> auto func)
 {
  if( enter )
    {
