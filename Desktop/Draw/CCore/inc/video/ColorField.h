...
concept VColorFieldType = requires(Meta::ToConst<Field> &field,MPoint p)
 {
  Ground<VColor>( field(p) );
 } ;

/* concept AlphaColorFieldType<Field> */

template <class Field> // ref extended
concept AlphaColorFieldType = requires(Meta::ToConst<Field> &field,MPoint p)
 {
  Ground<AlphaColor>( field(p) );
 } ;

/* concept ColorFieldType<Field> */

template <class Field> // ref extended
concept ColorFieldType = VColorFieldType<Field> || AlphaColorFieldType<Field> ;
