...
struct Dot
 {
  ...
  Dot(Dot dot,FuncType<MPoint,MPoint> auto func) : point(func(dot.point)),type(dot.type) {}
...
template <class R>
concept DotRangeType = Algon::RangeType<R> && requires(R &obj,ulen ind)
 {
  Ground<Dot>( *obj );
...
template <class Map,class R>
concept DotMapType = Algon::RangeType<R> && requires(R &obj,Map &map,ulen ind)
 {
  Ground<Dot>( map(*obj) );

  obj+=ind;

  Ground<Dot>( map(obj[ind]) );
 } ;
...
class DotsBase : NoCopy
 {
  ...
  protected:
   ...
   void addWithoutFirst(CursorOverType<MPoint> auto r)
    {
...
class PathDots : public DotsBase
 {
  ...
  public:
   ...
   template <class R>
   PathDots(R dots,MPointMapType<R> auto map,MCoord width)
    {
     if( !dots ) return;
   ...
   PathDots(MPointRangeType auto dots,MCoord width) : PathDots(dots, [] (MPoint point) { return point; } ,width) {}
...
class LoopDots : public DotsBase
 {
  ...
  public:
   ...
   template <class R>
   LoopDots(R dots,MPointMapType<R> auto map,MCoord width)
    {
     if( !dots ) return;
   ...
   LoopDots(MPointRangeType auto dots,MCoord width) : LoopDots(dots, [] (MPoint point) { return point; } ,width) {}
...
class HalfPathDots : public DotsBase
 {
  ...
  public:
   ...
   template <class R>
   HalfPathDots(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width)
    {
     if( !dots ) return;
   ...
   HalfPathDots(MPointRangeType auto dots,HalfFlag half_flag,MCoord width) : HalfPathDots(dots, [] (MPoint point) { return point; } ,half_flag,width) {}
...
class HalfLoopDots : public DotsBase
 {
  ...
  public:
   ...
   template <class R>
   HalfLoopDots(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width)
    {
     if( !dots ) return;
   ...
   HalfLoopDots(MPointRangeType auto dots,HalfFlag half_flag,MCoord width) : HalfLoopDots(dots, [] (MPoint point) { return point; } ,half_flag,width) {}
...
class CurveBase : public DotsBase
 {
  protected:
   ...
   template <class R>
   void buildLoop(R dots,MPointMapType<R> auto map)
    {
   ...
   template <class R>
   void extPath(R dots,MPointMapType<R> auto map,CurveDriver &driver)
    {
     switch( Algon::BaseRangeAlgo<R>::GetLen(dots) )
       {
        case 0 :
   ...
   template <class R>
   void extPath(R dots,R ext,MPointMapType<R> auto map,CurveDriver &driver)
    {
     switch( Algon::BaseRangeAlgo<R>::GetLen(dots) )
       {
        case 0 :
...
class CurvePath : public DotsBase
 {
  public:
   ...
   template <class R>
   CurvePath(R dots,MPointMapType<R> auto map)
    {
     switch( Algon::BaseRangeAlgo<R>::GetLen(dots) )
       {
        case 0 :
   ...
   explicit CurvePath(MPointRangeType auto dots) : CurvePath(dots, [] (MPoint point) { return point; } ) {}
...
class CurveLoop : public CurveBase
 {
  public:
   ...
   template <class R>
   CurveLoop(R dots,MPointMapType<R> auto map)
    {
     buildLoop(dots,map);
    }

   explicit CurveLoop(MPointRangeType auto dots) : CurveLoop(dots, [] (MPoint point) { return point; } ) {}
...
class CurveBreakPath : public CurveBase
 {
  public:
   ...
   template <DotRangeType R>
   CurveBreakPath(R dots,MPointMapType<R> auto map)
    {
     if( !dots ) return;
   ...
   explicit CurveBreakPath(DotRangeType auto dots) : CurveBreakPath(dots, [] (Dot dot) { return dot.point; } ) {}
...
class CurveBreakLoop : public CurveBase
 {
   template <DotRangeType R>
   void buildPath(R dots,R ext,MPointMapType<R> auto map)
    {
     StackObject<CurveDriver> driver(MaxFineness);
  ...
  public:
   ...
   template <DotRangeType R>
   CurveBreakLoop(R dots,MPointMapType<R> auto map)
    {
     if( !dots ) return;
   ...
   explicit CurveBreakLoop(DotRangeType auto dots) : CurveBreakLoop(dots, [] (Dot dot) { return dot.point; } ) {}
...
class GenDrawArt
 {
  ...
  protected:
   ...
   void path_gen(MPointRangeType auto dots,MCoord width,VColor vc)
    {
     path_gen(dots,width,ConstantField(vc));
    }

   void loop_gen(MPointRangeType auto dots,MCoord width,VColor vc)
    {
     loop_gen(dots,width,ConstantField(vc));
    }

   void path_gen(MPointRangeType auto dots,MCoord width,const ColorFieldType auto &field)
    {
   ...
   void loop_gen(MPointRangeType auto dots,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <class R>
   void path_gen(R dots,MPointMapType<R> auto map,MCoord width,VColor vc)
    {
     path_gen(dots,map,width,ConstantField(vc));
    }

   template <class R>
   void loop_gen(R dots,MPointMapType<R> auto map,MCoord width,VColor vc)
    {
     loop_gen(dots,map,width,ConstantField(vc));
    }

   template <class R>
   void path_gen(R dots,MPointMapType<R> auto map,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <class R>
   void loop_gen(R dots,MPointMapType<R> auto map,MCoord width,const ColorFieldType auto &field)
    {
   ...
   void path_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,VColor vc)
    {
     path_gen(dots,half_flag,width,ConstantField(vc));
    }

   void loop_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,VColor vc)
    {
     loop_gen(dots,half_flag,width,ConstantField(vc));
    }

   void path_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
   ...
   void loop_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <class R>
   void path_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,VColor vc)
    {
     path_gen(dots,map,half_flag,width,ConstantField(vc));
    }

   template <class R>
   void loop_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,VColor vc)
    {
     loop_gen(dots,map,half_flag,width,ConstantField(vc));
    }

   template <class R>
   void path_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <class R>
   void loop_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
   ...
   void curvePath_gen(MPointRangeType auto dots,MCoord width,VColor vc)
    {
     curvePath_gen(dots,width,ConstantField(vc));
    }

   void curveBreakPath_gen(DotRangeType auto dots,MCoord width,VColor vc)
    {
     curveBreakPath_gen(dots,width,ConstantField(vc));
    }

   void curveLoop_gen(MPointRangeType auto dots,MCoord width,VColor vc)
    {
     curveLoop_gen(dots,width,ConstantField(vc));
    }

   void curveBreakLoop_gen(DotRangeType auto dots,MCoord width,VColor vc)
    {
     curveBreakLoop_gen(dots,width,ConstantField(vc));
    }

   void curvePath_gen(MPointRangeType auto dots,MCoord width,const ColorFieldType auto &field)
    {
     CurvePath path(dots);
   ...
   void curveBreakPath_gen(DotRangeType auto dots,MCoord width,const ColorFieldType auto &field)
    {
   ...
   void curveLoop_gen(MPointRangeType auto dots,MCoord width,const ColorFieldType auto &field)
    {
     CurveLoop loop(dots);
   ...
   void curveBreakLoop_gen(DotRangeType auto dots,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <class R>
   void curvePath_gen(R dots,MPointMapType<R> auto map,MCoord width,VColor vc)
    {
     curvePath_gen(dots,map,width,ConstantField(vc));
    }

   template <DotRangeType R>
   void curveBreakPath_gen(R dots,MPointMapType<R> auto map,MCoord width,VColor vc)
    {
     curveBreakPath_gen(dots,map,width,ConstantField(vc));
    }

   template <class R>
   void curveLoop_gen(R dots,MPointMapType<R> auto map,MCoord width,VColor vc)
    {
     curveLoop_gen(dots,map,width,ConstantField(vc));
    }

   template <DotRangeType R>
   void curveBreakLoop_gen(R dots,MPointMapType<R> auto map,MCoord width,VColor vc)
    {
     curveBreakLoop_gen(dots,map,width,ConstantField(vc));
    }

   template <class R>
   void curvePath_gen(R dots,MPointMapType<R> auto map,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <DotRangeType R>
   void curveBreakPath_gen(R dots,MPointMapType<R> auto map,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <class R>
   void curveLoop_gen(R dots,MPointMapType<R> auto map,MCoord width,const ColorFieldType auto &field)
    {
   ...
   template <DotRangeType R>
   void curveBreakLoop_gen(R dots,MPointMapType<R> auto map,MCoord width,const ColorFieldType auto &field)
    {
   ...
   void curvePath_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curvePath_gen(dots,half_flag,width,ConstantField(vc));
    }

   void curveBreakPath_gen(DotRangeType auto dots,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curveBreakPath_gen(dots,half_flag,width,ConstantField(vc));
    }

   void curveLoop_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curveLoop_gen(dots,half_flag,width,ConstantField(vc));
    }

   void curveBreakLoop_gen(DotRangeType auto dots,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curveBreakLoop_gen(dots,half_flag,width,ConstantField(vc));
    }

   void curvePath_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurvePath path(dots);
   ...
   void curveBreakPath_gen(DotRangeType auto dots,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurveBreakPath path(dots);
   ...
   void curveLoop_gen(MPointRangeType auto dots,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurveLoop loop(dots);
   ...
   void curveBreakLoop_gen(DotRangeType auto dots,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurveBreakLoop loop(dots);
   ...
   template <class R>
   void curvePath_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curvePath_gen(dots,map,half_flag,width,ConstantField(vc));
    }

   template <DotRangeType R>
   void curveBreakPath_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curveBreakPath_gen(dots,map,half_flag,width,ConstantField(vc));
    }

   template <class R>
   void curveLoop_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curveLoop_gen(dots,map,half_flag,width,ConstantField(vc));
    }

   template <DotRangeType R>
   void curveBreakLoop_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,VColor vc)
    {
     curveBreakLoop_gen(dots,map,half_flag,width,ConstantField(vc));
    }

   template <class R>
   void curvePath_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurvePath path(dots,map);
   ...
   template <DotRangeType R>
   void curveBreakPath_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurveBreakPath path(dots,map);
   ...
   template <class R>
   void curveLoop_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurveLoop loop(dots,map);
   ...
   template <DotRangeType R>
   void curveBreakLoop_gen(R dots,MPointMapType<R> auto map,HalfFlag half_flag,MCoord width,const ColorFieldType auto &field)
    {
     CurveBreakLoop loop(dots,map);
   ...
   void solid_gen(MPointRangeType auto dots,SolidFlag solid_flag,VColor vc)
    {
     solid_gen(dots,solid_flag,ConstantField(vc));
    }

   void solid_gen(MPointRangeType auto dots,SolidFlag solid_flag,VColor vc,unsigned alpha)
    {
     solid_gen(dots,solid_flag,ConstantAlphaField(vc,alpha));
    }

   template <ColorFieldType Field>
   void solid_gen(MPointRangeType auto dots,SolidFlag solid_flag,const Field &field)
    {
   ...
   template <class R>
   void solid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,VColor vc)
    {
     solid_gen(dots,map,solid_flag,ConstantField(vc));
    }

   template <class R>
   void solid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,VColor vc,unsigned alpha)
    {
     solid_gen(dots,map,solid_flag,ConstantAlphaField(vc,alpha));
    }

   template <class R,ColorFieldType Field>
   void solid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,const Field &field)
    {
   ...
   void curveSolid_gen(MPointRangeType auto dots,SolidFlag solid_flag,VColor vc)
    {
     curveSolid_gen(dots,solid_flag,ConstantField(vc));
    }

   void curveSolid_gen(MPointRangeType auto dots,SolidFlag solid_flag,VColor vc,unsigned alpha)
    {
     curveSolid_gen(dots,solid_flag,ConstantAlphaField(vc,alpha));
    }

   void curveBreakSolid_gen(DotRangeType auto dots,SolidFlag solid_flag,VColor vc)
    {
     curveBreakSolid_gen(dots,solid_flag,ConstantField(vc));
    }

   void curveBreakSolid_gen(DotRangeType auto dots,SolidFlag solid_flag,VColor vc,unsigned alpha)
    {
     curveBreakSolid_gen(dots,solid_flag,ConstantAlphaField(vc,alpha));
    }

   void curveSolid_gen(MPointRangeType auto dots,SolidFlag solid_flag,const ColorFieldType auto &field)
    {
     CurveLoop loop(dots);
   ...
   void curveBreakSolid_gen(DotRangeType auto dots,SolidFlag solid_flag,const ColorFieldType auto &field)
    {
     CurveBreakLoop loop(dots);
   ...
   template <class R>
   void curveSolid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,VColor vc)
    {
     curveSolid_gen(dots,map,solid_flag,ConstantField(vc));
    }

   template <class R>
   void curveSolid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,VColor vc,unsigned alpha)
    {
     curveSolid_gen(dots,map,solid_flag,ConstantAlphaField(vc,alpha));
    }

   template <DotRangeType R>
   void curveBreakSolid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,VColor vc)
    {
     curveBreakSolid_gen(dots,map,solid_flag,ConstantField(vc));
    }

   template <DotRangeType R>
   void curveBreakSolid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,VColor vc,unsigned alpha)
    {
     curveBreakSolid_gen(dots,map,solid_flag,ConstantAlphaField(vc,alpha));
    }

   template <class R>
   void curveSolid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,const ColorFieldType auto &field)
    {
     CurveLoop loop(dots,map);
   ...
   template <DotRangeType R>
   void curveBreakSolid_gen(R dots,MPointMapType<R> auto map,SolidFlag solid_flag,const ColorFieldType auto &field)
    {
     CurveBreakLoop loop(dots,map);
   ...
   void knob_gen(MPoint center,MCoord len,const ColorFieldType auto &field)
    {
     MPoint temp[]=
      {
   ...
   void ball_gen(MPoint center,MCoord radius,const ColorFieldType auto &field)
    {
   ...
   void circle_gen(MPoint center,MCoord radius,MCoord width,const ColorFieldType auto &field)
    {
     LineRound obj(center,radius);
