...
class FavList : NoCopy
 {
  ...
  public:
   ...
   void apply(ulen count,FuncArgType<ulen,StrLen,StrLen,bool,bool,bool> auto func) const // ind title path section open cur
    {
     if( !count ) return;
   ...
   void apply(ulen count,FuncType<bool,ulen,StrLen,StrLen,bool,bool,bool> auto func) const // ind title path section open cur
    {
     if( !count ) return;
