...
struct BitmapData
 {
  ...
  void loadBitmap(const AbstFileToRead &file,StrLen file_name);
  ...
  void loadZipmap(const AbstFileToRead &file,StrLen file_name);
...
class Bitmap
 {
  ...
  private:
   ...
   void fill(FuncType<uint32> auto next);

   void load(const BitmapData &data);

   void load(StrLen file_name);

   void load(const AbstFileToRead &file,StrLen file_name);
  ...
  public:
   ...
   Bitmap(const AbstFileToRead &file,StrLen dir,StrLen file_name);
