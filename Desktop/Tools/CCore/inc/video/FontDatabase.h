...
struct FontInfo
 {
  ...
  void printDDL(PrinterType auto &out) const
   {
    Printf(out,"{ #; , #; , #; , #; , #; , #; , #; , #; }",
...
class FontIndex : NoCopy
 {
  ...
  public:
   ...
   void build(const FontDatabase &fdb,FuncType<bool,const FontInfo &> auto filter,FuncType<CmpResult,const FontInfo &,const FontInfo &> auto cmp)
    {
   ...
   const FontInfo * find(FuncType<CmpResult,const FontInfo &> auto func) const // func(list) monotonic
    {
     auto r=getList();
