...
void MD5Core::State::Round1(uint32 &a,uint32 &b,uint32 &c,uint32 &d,const uint32 X[BlockWordLen])
 {
  constexpr uint32 T0  = 0xd76aa478 ;
  constexpr uint32 T1  = 0xe8c7b756 ;
  constexpr uint32 T2  = 0x242070db ;
  constexpr uint32 T3  = 0xc1bdceee ;

  constexpr uint32 T4  = 0xf57c0faf ;
  constexpr uint32 T5  = 0x4787c62a ;
  constexpr uint32 T6  = 0xa8304613 ;
  constexpr uint32 T7  = 0xfd469501 ;

  constexpr uint32 T8  = 0x698098d8 ;
  constexpr uint32 T9  = 0x8b44f7af ;
  constexpr uint32 T10 = 0xffff5bb1 ;
  constexpr uint32 T11 = 0x895cd7be ;

  constexpr uint32 T12 = 0x6b901122 ;
  constexpr uint32 T13 = 0xfd987193 ;
  constexpr uint32 T14 = 0xa679438e ;
  constexpr uint32 T15 = 0x49b40821 ;
...
void MD5Core::State::Round2(uint32 &a,uint32 &b,uint32 &c,uint32 &d,const uint32 X[BlockWordLen])
 {
  constexpr uint32 T0  = 0xf61e2562 ;
  constexpr uint32 T1  = 0xc040b340 ;
  constexpr uint32 T2  = 0x265e5a51 ;
  constexpr uint32 T3  = 0xe9b6c7aa ;

  constexpr uint32 T4  = 0xd62f105d ;
  constexpr uint32 T5  = 0x02441453 ;
  constexpr uint32 T6  = 0xd8a1e681 ;
  constexpr uint32 T7  = 0xe7d3fbc8 ;

  constexpr uint32 T8  = 0x21e1cde6 ;
  constexpr uint32 T9  = 0xc33707d6 ;
  constexpr uint32 T10 = 0xf4d50d87 ;
  constexpr uint32 T11 = 0x455a14ed ;

  constexpr uint32 T12 = 0xa9e3e905 ;
  constexpr uint32 T13 = 0xfcefa3f8 ;
  constexpr uint32 T14 = 0x676f02d9 ;
  constexpr uint32 T15 = 0x8d2a4c8a ;
...
void MD5Core::State::Round3(uint32 &a,uint32 &b,uint32 &c,uint32 &d,const uint32 X[BlockWordLen])
 {
  constexpr uint32 T0  = 0xfffa3942 ;
  constexpr uint32 T1  = 0x8771f681 ;
  constexpr uint32 T2  = 0x6d9d6122 ;
  constexpr uint32 T3  = 0xfde5380c ;

  constexpr uint32 T4  = 0xa4beea44 ;
  constexpr uint32 T5  = 0x4bdecfa9 ;
  constexpr uint32 T6  = 0xf6bb4b60 ;
  constexpr uint32 T7  = 0xbebfbc70 ;

  constexpr uint32 T8  = 0x289b7ec6 ;
  constexpr uint32 T9  = 0xeaa127fa ;
  constexpr uint32 T10 = 0xd4ef3085 ;
  constexpr uint32 T11 = 0x04881d05 ;

  constexpr uint32 T12 = 0xd9d4d039 ;
  constexpr uint32 T13 = 0xe6db99e5 ;
  constexpr uint32 T14 = 0x1fa27cf8 ;
  constexpr uint32 T15 = 0xc4ac5665 ;
...
void MD5Core::State::Round4(uint32 &a,uint32 &b,uint32 &c,uint32 &d,const uint32 X[BlockWordLen])
 {
  constexpr uint32 T0  = 0xf4292244 ;
  constexpr uint32 T1  = 0x432aff97 ;
  constexpr uint32 T2  = 0xab9423a7 ;
  constexpr uint32 T3  = 0xfc93a039 ;

  constexpr uint32 T4  = 0x655b59c3 ;
  constexpr uint32 T5  = 0x8f0ccc92 ;
  constexpr uint32 T6  = 0xffeff47d ;
  constexpr uint32 T7  = 0x85845dd1 ;

  constexpr uint32 T8  = 0x6fa87e4f ;
  constexpr uint32 T9  = 0xfe2ce6e0 ;
  constexpr uint32 T10 = 0xa3014314 ;
  constexpr uint32 T11 = 0x4e0811a1 ;

  constexpr uint32 T12 = 0xf7537e82 ;
  constexpr uint32 T13 = 0xbd3af235 ;
  constexpr uint32 T14 = 0x2ad7d2bb ;
  constexpr uint32 T15 = 0xeb86d391 ;
