...
void AsyncFile::close(FileMultiError &errout)
 {
  if( !is_opened )
    {
...
void AsyncFileSystem::guard(const char *name,StrLen arg1)
 {
  if( error )
    {
     Printf(Exception,"CCore::AsyncFileSystem::#;(#.q;) : #;",name,arg1,error);
    }
 }

void AsyncFileSystem::guard(const char *name,StrLen arg1,StrLen arg2)
 {
  if( error )
    {
     Printf(Exception,"CCore::AsyncFileSystem::#;(#.q;,#.q;) : #;",name,arg1,arg2,error);
    }
 }

void AsyncFileSystem::guard(const char *name,StrLen arg1,StrLen arg2,StrLen arg3)
 {
  if( error )
    {
     Printf(Exception,"CCore::AsyncFileSystem::#;(#.q;,#.q;,#.q;) : #;",name,arg1,arg2,arg3,error);
    }
 }
