...
EventIdType ClientEventRegType::Register(EventMetaInfo &info)
 {
  return info.addEnum_uint8("PTPClient"_str)

             .addValueName(ClientEvent_Trans,"Trans"_str,EventMarker_UpPush)
             .addValueName(ClientEvent_TransDone,"Trans done"_str,EventMarker_Stop)

             .addValueName(ClientEvent_BadInfoLen,"Bad info len"_str,EventMarker_Error)
             .addValueName(ClientEvent_Timeout,"Timeout"_str,EventMarker_Pass)
             .addValueName(ClientEvent_Cancel,"Cancel"_str,EventMarker_Pass)
             .addValueName(ClientEvent_Abort,"Abort"_str,EventMarker_Pass)

             .addValueName(ClientEvent_CALL,"-> CALL"_str,EventMarker_Up)
             .addValueName(ClientEvent_RECALL,"-> RECALL"_str,EventMarker_Up)
             .addValueName(ClientEvent_ACK,"-> ACK"_str,EventMarker_Up)
             .addValueName(ClientEvent_SENDRET,"-> SENDRET"_str,EventMarker_Up)

             .addValueName(ClientEvent_RET,"<- RET"_str,EventMarker_Down)
             .addValueName(ClientEvent_NOINFO,"<- NOINFO"_str,EventMarker_Down)
             .addValueName(ClientEvent_RERET,"<- RERET"_str,EventMarker_Down)
             .addValueName(ClientEvent_CANCEL,"<- CANCEL"_str,EventMarker_Down)

             .addValueName(ClientEvent_NoSlot,"No slot"_str,EventMarker_DownBlock)
             .addValueName(ClientEvent_NoPacket,"No packet"_str,EventMarker_Error)

             .addValueName(ClientEvent_BadInbound,"Bad inbound"_str,EventMarker_Error)
             .addValueName(ClientEvent_BadOutbound,"Bad outbound"_str,EventMarker_Error)
...
void ClientProtoEvent::Register(EventMetaInfo &info,EventMetaInfo::EventDesc &desc)
 {
  auto id=info.addStruct("PTPClientEvent"_str)
              .addField_uint32<&ClientProtoEvent::time>("time"_str)
              .addField_uint16<&ClientProtoEvent::id>("id"_str)
              .addField_enum_uint8<&ClientProtoEvent::ev>(EventTypeId<ClientEventRegType>::GetId(),"event"_str)
              .getId();
...
void ClientProtoEvent_slot::Register(EventMetaInfo &info,EventMetaInfo::EventDesc &desc)
 {
  auto id=info.addStruct("PTPClientEventSlot"_str)
              .addField_uint32<&ClientProtoEvent_slot::time>("time"_str)
              .addField_uint16<&ClientProtoEvent_slot::id>("id"_str)
              .addField_enum_uint8<&ClientProtoEvent_slot::ev>(EventTypeId<ClientEventRegType>::GetId(),"event"_str)
              .addField_uint32<&ClientProtoEvent_slot::slot>("slot"_str)
              .getId();
