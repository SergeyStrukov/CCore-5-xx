...
FileError FileSystemDevice::MakeError(Ext *ext,FileError fe)
 {
  switch( ext->result )
    {
     case Trans_Ok :
...
template <PTP::ExtType Ext>
void FileSystemDevice::complete_ext(PacketHeader *packet_)
 {
...
void FileSystemDevice::getFileType(Packet<uint8,Sys::AsyncFileSystem::FileTypeExt> packet,StrLen path)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileSystemDevice::complete_getFileType>());
...
void FileSystemDevice::getFileUpdateTime(Packet<uint8,Sys::AsyncFileSystem::CmpFileTimeExt> packet,StrLen path)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileSystemDevice::complete_getFileUpdateTime>());
...
void FileSystemDevice::getFileList(ObjHook &hook,Packet<uint8,Sys::AsyncFileSystem::FileExt> packet,StrLen path)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileSystemDevice::complete_getFileList>());
...
void FileSystemDevice::exec2(ObjHook &hook,Packet<uint8,Sys::AsyncFileSystem::FileExt> packet,StrLen dir,StrLen program)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileSystemDevice::complete_exec2>());
...
void FileSystemDevice::FileState::open(Packet<uint8,Sys::AsyncFile::OpenExt> packet,StrLen file_name,FileOpenFlags oflags)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileState::complete_open>());
...
void FileSystemDevice::FileState::close(Packet<uint8,Sys::AsyncFile::CloseExt> packet,bool preserve_file)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileState::complete_close>());
...
void FileSystemDevice::FileState::write(Packet<uint8,Sys::AsyncFile::WriteExt> packet,FilePosType off)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileState::complete_write>());
...
void FileSystemDevice::FileState::read(Packet<uint8,Sys::AsyncFile::ReadExt> packet)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileState::complete_read>());
...
void FileSystemDevice::FileState::read(Packet<uint8,Sys::AsyncFile::ReadBufExt> packet)
 {
  ...
  packet2.pushCompleteFunction(functionOf<&FileState::complete_readbuf>());
