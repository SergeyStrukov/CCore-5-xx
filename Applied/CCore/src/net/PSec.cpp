...
EventIdType EventRegType::Register(EventMetaInfo &info)
 {
  return info.addEnum_uint8("PSecEventType"_str)

             .addValueName(ProcessorEvent_Rx,"Rx"_str,EventMarker_Up)
             .addValueName(ProcessorEvent_RxBadLen,"Rx BadLen"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_RxBadPadLen,"Rx BadPadLen"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_RxReplay,"Rx Replay"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_RxBadKeyIndex,"Rx BadKeyIndex"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_RxBadHash,"Rx BadHash"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_RxDone,"Rx Done"_str,EventMarker_Down)

             .addValueName(ProcessorEvent_Tx,"Tx"_str,EventMarker_Up)
             .addValueName(ProcessorEvent_TxBadFormat,"Tx BadFormat"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_TxNoKey,"Tx NoKey"_str,EventMarker_DownBlock)
             .addValueName(ProcessorEvent_TxDone,"Tx Done"_str,EventMarker_Down)

             .addValueName(ProcessorEvent_KeyNoPacket,"Key NoPacket"_str,EventMarker_Error)
             .addValueName(ProcessorEvent_KeyBadFormat,"Key BadFormat"_str,EventMarker_Error)

             .addValueName(ProcessorEvent_KeyAlert,"Key Alert"_str)
             .addValueName(ProcessorEvent_KeyReady,"Key Ready"_str)
             .addValueName(ProcessorEvent_KeyAck,"Key Ack"_str)
             .addValueName(ProcessorEvent_KeyStop,"Key Stop"_str)

             .addValueName(ProcessorEvent_Ping,"Ping"_str)
             .addValueName(ProcessorEvent_Pong,"Pong"_str)
             .addValueName(ProcessorEvent_Close,"Close"_str)
...
void ProtoEvent::Register(EventMetaInfo &info,EventMetaInfo::EventDesc &desc)
 {
  auto id=info.addStruct("PSecEvent"_str)
              .addField_uint32<&ProtoEvent::time>("time"_str)
              .addField_uint16<&ProtoEvent::id>("id"_str)
              .addField_enum_uint8<&ProtoEvent::ev>(EventTypeId<EventRegType>::GetId(),"event"_str)
              .getId();
...
auto PacketProcessor::inbound(ControlResponse &resp,PtrLen<uint8> data) -> InboundResult
 {
...

  {
   ...
   if( !Range_const(hash,hlen).equalTo(base+len) )
     {
...
class MultipointDevice::PointList : NoCopy
 {
  ...
  public:
   ...
   void consume(FuncArgType<XPoint> auto func)
    {
