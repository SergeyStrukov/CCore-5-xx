...
class TestIntegerAlgo : TestIntBase
 {
   ...
   static constexpr unsigned Len = 100 ;
   static constexpr unsigned GLen = 10 ;
  ...
  private:
   ...
   void guard(const char *msg)
    {
     if( !Range(g,GLen).equalTo(a+na) ) Error(msg);
    }

   void same(const char *msg)
    {
     if( !Range(a,na).equalTo(d) ) Error(msg);
    }

   void same(Unit c,Unit c1,const char *msg)
    {
     if( c!=c1 || !Range(a,na).equalTo(d) ) Error(msg);
    }

   void same_b(Unit c,Unit c1,const char *msg)
    {
     if( c!=c1 || !Range(a,na).equalTo(b) ) Error(msg);
    }
   ...
   void guard_c(const char *msg)
    {
     if( !Range(g,GLen).equalTo(c+nc) ) Error(msg);
    }
     ...
     if( a&Algo::MSBit )
       {
        if( b&Algo::MSBit )
          {
           if( Algo::SignCmp(a,b)!=Cmp(a,b) ) Error("Algo::SignCmp(<0,<0)");
          }
        else
          {
   ...
   void test33()
    {
     ...
     if( !Range(a,delta).equalTo(d) ) Error("Algo::ShiftUp 1");
   ...
   void test35()
    {
     ...
     if( !Range(a+n,delta).equalTo(d+n) ) Error("Algo::ShiftDown 1");
   ...
   void test37()
    {
     ...
     if( !Range(a,delta).equalTo(d) ) Error("Algo::MoveUp 1");

     if( !Range(a+delta,n).equalTo(d) ) Error("Algo::MoveUp 2");
    }
   ...
   void test38()
    {
     ...
     if( !Range(a+n,delta).equalTo(d+n) ) Error("Algo::MoveDown 1");

     if( !Range(a,n).equalTo(d+delta) ) Error("Algo::MoveDown 2");
    }
   ...
   void test39()
    {
     ...
     if( !Range(c,nc).equalTo(d) ) Error("Algo::UMul");
    }
   ...
   void test40()
    {
     ...
     if( !Range(c,nc).equalTo(d) ) Error("Algo::UMulLo");
    }
   ...
   void test41()
    {
     ...
     if( !Range(c,nc).equalTo(d) ) Error("Algo::Mul");
    }
   ...
   void test45()
    {
     ...
     if( carry1!=carry2 || !Range(c,nc).equalTo(d) ) Error("Algo::UMac");
    }
   ...
   void test46()
    {
     ...
     if( !Range(c,nc).equalTo(d) ) Error("Algo::USq");
    }
   ...
   void test47()
    {
     ...
     if( !Range(c,nc).equalTo(d) ) Error("Algo::Sq");
    }
   ...
   void test48()
    {
     ...
     if( !Range(a,delta).equalTo(d) ) Error("Algo::UShiftUp 1");
   ...
   void test49()
    {
     ...
     if( !Range(a+n,delta).equalTo(d+n) ) Error("Algo::UShiftDown 1");
