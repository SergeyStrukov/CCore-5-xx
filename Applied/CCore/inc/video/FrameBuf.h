...
template <class Pattern> // ref extended
concept BoolPatternType = NothrowCopyableType<Pattern> && requires(Meta::ToConst<Pattern> &cobj,Coord x)
 {
  Ground<Coord>( cobj.dX() ); // > 0
...
template <class Glyph> // ref extended
concept BoolGlyphType = NothrowCopyableType<Glyph> && requires(Meta::ToConst<Glyph> &cobj,Coord y)
 {
  Ground<Coord>( cobj.dX() ); // > 0

  Ground<Coord>( cobj.dY() ); // > 0
...
template <class Fill,class RawColor>
concept RasterFillType = RawColorType<RawColor> && requires(Fill fill,Coord x,Coord y,Coord dx,typename RawColor::Raw *ptr)
 {
  fill(x,y,dx,ptr);
 } ;
...
class FrameBuf : protected ColorPlane
 {
  ...
  private:
   ...
   static void HLine(Raw *ptr,Coord len,BlenderType auto blender);

   static void Save(Raw *ptr,Coord len,RawColor buf[/* len */]);

   static void Load(Raw *ptr,Coord len,const RawColor buf[/* len */]);

   static void HLine(Raw *ptr,BoolPatternType auto pat,RawColor back,RawColor fore);

   static void HLine(Raw *ptr,BoolPatternType auto pat,RawColor fore);

   static void HLine(Raw *ptr,BoolPatternType auto pat,Coord gx,Coord lim,RawColor fore); // gx < lim
  ...
  public:
   ...
   void glyph_unsafe(Point p,BoolGlyphType auto gly,RawColor back,RawColor fore);

   void glyph_unsafe(Point p,BoolGlyphType auto gly,RawColor fore);
   ...
   void fill_unsafe(Pane pane,Point off,RasterFillType<RawColor> auto fill);
   ...
   void block_safe(Pane pane,BlenderType auto blender);

   void block_safe(Pane pane,VColor vc,Clr alpha);

   void glyph_safe(Point p,BoolGlyphType auto gly,RawColor fore);
   ...
   void fill_safe(Pane pane,RasterFillType<RawColor> auto fill);
 };
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::HLine(Raw *ptr,Coord len,BlenderType auto blender)
 {
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::HLine(Raw *ptr,BoolPatternType auto pat,RawColor back,RawColor fore)
 {
  Coord bdx=pat.dX();
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::HLine(Raw *ptr,BoolPatternType auto pat,RawColor fore)
 {
  Coord bdx=pat.dX();
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::HLine(Raw *ptr,BoolPatternType auto pat,Coord gx,Coord lim,RawColor fore)
 {
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::pixel_unsafe(Point p,BlenderType auto blender)
 {
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::block_unsafe(Pane pane,BlenderType auto blender)
 {
  if( !pane ) return;
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::glyph_unsafe(Point p,BoolGlyphType auto gly,RawColor back,RawColor fore)
 {
  Coord bdy=gly.dY();
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::glyph_unsafe(Point p,BoolGlyphType auto gly,RawColor fore)
 {
  Coord bdy=gly.dY();
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::fill_unsafe(Pane pane,Point off,RasterFillType<RawColor> auto fill)
 {
  if( !pane ) return;
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::block_safe(Pane pane,BlenderType auto blender)
 {
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::glyph_safe(Point p,BoolGlyphType auto gly,RawColor fore)
 {
  if( !*this ) return;
...
template <RawColorType RawColor>
void FrameBuf<RawColor>::fill_safe(Pane pane,RasterFillType<RawColor> auto fill)
 {
