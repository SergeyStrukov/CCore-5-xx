...
class AsyncFileSystem : public Funchor_nocopy
 {
  ...
  private:
   ...
   void guard(const char *name,StrLen arg1);

   void guard(const char *name,StrLen arg1,StrLen arg2);

   void guard(const char *name,StrLen arg1,StrLen arg2,StrLen arg3);
