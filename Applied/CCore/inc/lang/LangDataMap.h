...
class DataMap : NoCopy
 {
  ...
  public:
   ...
   void atoms(FuncArgType<ulen,StrLen> auto func) const // func(1-based atom index,StrLen name)
    {
   ...
   class RuleList
    {
     ...
     public:
      ...
      void operator () (FuncArgType<StrLen,ArgList> auto func) const // func(StrLen rule_name,ArgList arg_list)
       {
   ...
   void synts(FuncArgType<StrLen,RuleList> auto func) const // func(StrLen name,RuleList rule_list)
    {
   ...
   void rules(FuncArgType<ulen,StrLen,StrLen,ulen> auto func) const // func(1-based rule index,StrLen synt_name,StrLen rule_name,1-based element index)
    {
   ...
   class ActionList
    {
     ...
     public:
      ...
      void operator () (FuncArgType<ulen,ulen> auto func) const // func(1-based atom index OR 0,1-based rule index OR 0)
       {
   ...
   void finals(FuncArgType<ulen,ActionList> auto func) const // func(0-based final index,ActionList action_list)
    {
   ...
   class TransList
    {
     ...
     public:
      ...
      void operator () (FuncArgType<ulen,ulen> auto func) const // func(1-based element index,0-based state index)
       {
   ...
   void states(FuncArgType<ulen,ulen,TransList> auto func) const // func(0-based state index,0-based final index,TransList trans_list)
    {
