...
class IntervalTree
 {
   ...
   MiniDynArray<Node> buf;
   MiniDynArray<Rec> rec_buf;
  ...
  public:
   ...
   void find(T point,FuncArgType<ulen> auto func) const // func(index)
    {
     Find(point,func,root.getPtr());
    }

   bool find(T point,FuncType<bool,ulen> auto func) const // func(index), return false to break
    {
