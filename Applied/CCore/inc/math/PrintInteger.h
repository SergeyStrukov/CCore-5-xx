...
class PrintInteger : NoCopy
 {
  ...
  private:
   ...
   bool print_lo_short(PrinterType auto &out,PtrLen<const Unit> body,ulen k) const;

   bool print_short(PrinterType auto &out,ulen width,PtrLen<const Unit> body) const;

   void print_lo(PrinterType auto &out,ulen k) const;

   void print_lo(PrinterType auto &out,Integer a,ulen k) const;

   //
   // a < 10^(2^(k+1)) , k <= K
   //

   void print(PrinterType auto &out,ulen width,Integer a,ulen k) const;
  ...
  public:
   ...
   void operator () (PrinterType auto &out,IntegerPrintOpt opt,Integer a) const;
 };
...
template <class Integer>
bool PrintInteger<Integer>::print_lo_short(PrinterType auto &out,PtrLen<const Unit> body,ulen k) const
 {
  unsigned value;
...
template <class Integer>
bool PrintInteger<Integer>::print_short(PrinterType auto &out,ulen width,PtrLen<const Unit> body) const
 {
  unsigned value;
...
template <class Integer>
void PrintInteger<Integer>::print_lo(PrinterType auto &out,ulen k) const
 {
...
template <class Integer>
void PrintInteger<Integer>::print_lo(PrinterType auto &out,Integer a,ulen k) const
 {
...
template <class Integer>
void PrintInteger<Integer>::print(PrinterType auto &out,ulen width,Integer a,ulen k) const
 {
...
template <class Integer>
void PrintInteger<Integer>::operator () (PrinterType auto &out,IntegerPrintOpt opt,Integer a) const
 {
  switch( a.sign() )
    {
     case CmpLess :
