...
struct LenInput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::to_server_info_len,&T::to_client_info_len);
   }
 };
...
struct ErrorDescInput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::service_id,&T::function_id,&T::error_id);
   }
 };
