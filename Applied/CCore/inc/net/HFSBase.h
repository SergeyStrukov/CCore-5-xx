...
struct FileId
 {
  ...
  friend bool operator == (const FileId &a,const FileId &b) = default;
...
struct OpenOutput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::file_id,&T::file_len);
   }
 };
...
struct ReadInput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::file_id,&T::off,&T::len);
   }
 };
...
struct CloseInput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::preserve_file,&T::file_id);
   }
 };
...
struct SaveLoadPath
 {
  ...
  void load(RangeLoadDevType auto &dev)
   {
    LenType len=0;
...
struct RenameInput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::allow_overwrite,&T::old_path,&T::new_path);
   }
 };
...
struct ExecInput
 {
  ...
  static constexpr auto Fold()
   {
    return Ret(&T::dir,&T::program,&T::arg);
   }
 };
