...
Geometry::Real Contour::ToReal(AnyType auto x)
 {
  return Real::Bin{x.mantissa,x.exp};
 }

void Contour::CopyFlags(Label &label,AnyType auto x)
 {
  label.show=x.show;
  label.gray=x.gray;
...
struct Contour::CreateDataFormulaObject : CreateDataPadObject
 {
  ...
  Object createArg(AnyType auto ptr)
   {
