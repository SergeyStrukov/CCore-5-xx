...
class CompactList : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CompactList<T> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit CompactList(ToMoveCtor<CompactList<T> > obj) noexcept
...
class CompactList2 : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CompactList2<T> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit CompactList2(ToMoveCtor<CompactList2<T> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(obj->list)
    {
    }
...
class CompactCircularList : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CompactCircularList<T> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit CompactCircularList(ToMoveCtor<CompactCircularList<T> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(Replace_null(obj->list))
    {
    }
