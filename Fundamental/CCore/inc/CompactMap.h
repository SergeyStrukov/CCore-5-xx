...
class CompactRBTreeMap : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CompactRBTreeMap<K,T,KRef> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(root,obj.root);
    }

   explicit CompactRBTreeMap(ToMoveCtor<CompactRBTreeMap<K,T,KRef> > obj) noexcept
...
class CompactRadixTreeMap : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CompactRadixTreeMap<K,T> &obj) noexcept
    {
   ...
   explicit CompactRadixTreeMap(ToMoveCtor<CompactRadixTreeMap<K,T> > obj) noexcept
    : key_range(obj->key_range),
      allocator(ToMoveCtor(obj->allocator)),
      root(obj->root)
    {
