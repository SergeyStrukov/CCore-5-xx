...
class LinearSList : NoCopy
 {
  ...
  public:
   ...
   template <class S,class ... SS> requires ( ConstructibleType<T,SS...> )
   ...
   auto apply(FuncInitArgType<T &> auto func_init) { return Algon::ApplyToRange(getStart(),func_init); }

   auto apply(FuncInitArgType<const T &> auto func_init) const { return Algon::ApplyToRange(getStart(),func_init); }

   auto apply_const(FuncInitArgType<const T &> auto func_init) const { return Algon::ApplyToRange(getStart(),func_init); }

   // swap/move objects

   void objSwap(LinearSList<T,Allocator> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit LinearSList(ToMoveCtor<LinearSList<T,Allocator> > obj) noexcept
...
class LinearSList2 : NoCopy
 {
  ...
  public:
   ...
   void objSwap(LinearSList2<T,Allocator> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit LinearSList2(ToMoveCtor<LinearSList2<T,Allocator> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(Replace_null(obj->list))
    {
    }
...
class CircularSList : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CircularSList<T,Allocator> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit CircularSList(ToMoveCtor<CircularSList<T,Allocator> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(Replace_null(obj->list))
    {
    }
...
class LinearDList : NoCopy
 {
  ...
  public:
   ...
   void objSwap(LinearDList<T,Allocator> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit LinearDList(ToMoveCtor<LinearDList<T,Allocator> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(Replace_null(obj->list))
    {
    }
...
class LinearDList2 : NoCopy
 {
  ...
  public:
   ...
   auto applyReverse(FuncInitArgType<T &> auto func_init) { return Algon::ApplyToRange(getStartReverse(),func_init); }

   auto applyReverse(FuncInitArgType<const T &> auto func_init) const { return Algon::ApplyToRange(getStartReverse(),func_init); }

   auto applyReverse_const(FuncInitArgType<const T &> auto func_init) const { return Algon::ApplyToRange(getStartReverse(),func_init); }

   // swap/move objects

   void objSwap(LinearDList2<T,Allocator> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit LinearDList2(ToMoveCtor<LinearDList2<T,Allocator> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(Replace_null(obj->list))
    {
    }
...
class CircularDList : NoCopy
 {
  ...
  public:
   ...
   void objSwap(CircularDList<T,Allocator> &obj) noexcept
    {
     Swap(allocator,obj.allocator);
     Swap(list,obj.list);
    }

   explicit CircularDList(ToMoveCtor<CircularDList<T,Allocator> > obj) noexcept
    : allocator(ToMoveCtor(obj->allocator)),
      list(Replace_null(obj->list))
    {
    }
