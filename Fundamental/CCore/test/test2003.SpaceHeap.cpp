...
class Heap : NoCopy
 {
  ...
  public:
   ...
   ulen getLen(const void *mem) noexcept { return heap.getLen(mem); }
   ...
   DeltaLen extend(void *mem,ulen len) noexcept
    {
   ...
   DeltaLen shrink(void *mem,ulen len) noexcept
    {
