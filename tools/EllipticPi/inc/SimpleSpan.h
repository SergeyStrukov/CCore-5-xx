...
class StrPunct : NoCopy
 {
  ...
  public:
   ...
   void operator () (PrinterType auto &out,bool more)
     {
      if( more )
        {
         if( --ind )
...
void PrintDigits(PrinterType auto &out,PtrLen<const char> str)
 {
  StrPunct punct(5);
...
class SimpleSpan
 {
  ...
  public:
   ...
   void print(PrinterType auto &out,unsigned dexp) const;
...
template <class Int>
void SimpleSpan<Int>::print(PrinterType auto &out,unsigned dexp) const
 {
...
template <class Int>
void SimpleSpan<Int>::print(PrinterType auto &out) const
 {
