...
class NameDirectory : NoCopy
 {
   ...
   struct Dir : DirName , MemBase_nocopy
    {
     ...
     void printUsing(PrinterType auto &out,StrLen prefix) const
      {
     ...
     void print(PrinterType auto &out,StrLen name=Empty,ulen off=0) const
      {
       if( index )
  ...
  public:
   ...
   void printStruct(PrinterType auto &out,StrLen prefix,DDL::StructNode &node) const
    {
   ...
   void printExtra(PrinterType auto &out,StrLen prefix,ulen ind) const
    {
   ...
   void printRoot(PrinterType auto &out,StrLen prefix) const
    {
